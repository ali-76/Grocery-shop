...
export function Banner({title , subTitle , img , bgImg}: Props) {
    //TODO implement form
  return (
    <>
        <div style={{backgroundImage : `url(${bgImg})`}} className={`grid grid-cols-2 items-center rounded-lg bg-[#FDC040] bg-opacity-20 bg-cover bg-no-repeat`}>
          ...
          <ImageView src={img} alt="banner image" width={717} height={538} className="m-w-[50%]" />
        </div>
